...
public class RegistrationUser {
    ...
    public String addUser(@RequestParam String userName, @RequestParam String login, @RequestParam String password, @RequestParam String email, Model model, Map<String, Object> mod) {
